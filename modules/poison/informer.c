...
void informTaskStructOffsets()
{
    ...
    printk("offset of struct vm_area_struct vmacache1 \t %lu\n", offsetof(struct task_struct, vmacache1));
    printk("offset of struct vm_area_struct vmacache2 \t %lu\n", offsetof(struct task_struct, vmacache2));
    printk("offset of struct vm_area_struct vmacache3 \t %lu\n", offsetof(struct task_struct, vmacache3));
    printk("offset of struct vm_area_struct vmacache4 \t %lu\n", offsetof(struct task_struct, vmacache4));
    ...
    printk("offset of unsigned int bits1 \t %lu\n", offsetof(struct task_struct, bits1));
    printk("offset of unsigned int bits2 \t %lu\n", offsetof(struct task_struct, bits2));
    ...
    printk("offset of struct pid_link pids1 \t %lu\n", offsetof(struct task_struct, pids1));
    printk("offset of struct pid_link pids2 \t %lu\n", offsetof(struct task_struct, pids2));
    printk("offset of struct pid_link pids3 \t %lu\n", offsetof(struct task_struct, pids3));
    ...
    printk("offset of struct list_head cpu_timers1 \t %lu\n", offsetof(struct task_struct, cpu_timers1));
    printk("offset of struct list_head cpu_timers2 \t %lu\n", offsetof(struct task_struct, cpu_timers2));
    printk("offset of struct list_head cpu_timers3 \t %lu\n", offsetof(struct task_struct, cpu_timers3));
    ...
    printk("offset of struct perf_event_context perf_event_ctxp1 \t %lu\n", offsetof(struct task_struct, perf_event_ctxp1));
    printk("offset of struct perf_event_context perf_event_ctxp2 \t %lu\n", offsetof(struct task_struct, perf_event_ctxp2));
